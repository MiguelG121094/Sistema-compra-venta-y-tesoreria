...
<head>
    ...
    <!--<script src="Theme/js/buscadorGenerico.js" type="text/javascript"></script>-->
    <script src="Bootstrap 5.3.3/js/jquery.mask.min.js" type="text/javascript"></script> <!-- mascara para ruc, tel, etc-->
    <link href="toastr/build/toastr.min.css" rel="stylesheet" type="text/css"/> <!-- libreria de mensaje -->
    <script src="toastr/build/toastr.min.js" type="text/javascript"></script> <!-- libreria de mensaje -->
</head>
