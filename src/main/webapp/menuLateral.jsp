                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link ${menuActivo eq 'movimientoDebito' ? 'active' : ''}" href="MovimientoBancarioServlet?menu=MovimientoBancario&tipo=debito&accion=Listar">Cargar otros débitos</a>
                            <a class="nav-link ${menuActivo eq 'movimientoCredito' ? 'active' : ''}" href="MovimientoBancarioServlet?menu=MovimientoBancario&tipo=credito&accion=Listar">Cargar otros créditos</a>
                        </nav>
                    </div>
