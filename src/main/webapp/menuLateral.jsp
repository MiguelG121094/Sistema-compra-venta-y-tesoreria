...
<!--bloque de codigo que hace que las p�ginas JSP solo sean accesibles si el 
usuario inicio sesion, se debe agregar esta validaci�n en cada una de las vistas JSP-->
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="sb-sidenav-menu-heading">M�dulo Compras</div>
                    ...
                    <div class="collapse" id="collapseCompraMoviminetos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="layout-sidenav-light.html">Notas de Cr�dito y D�bito</a>
                        </nav>
                    </div>
                    
                    <div class="sb-sidenav-menu-heading">M�dulo Tesorer�a</div>
