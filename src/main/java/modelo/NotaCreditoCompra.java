 ...
 * @author Miguel
 */
public class NotaCreditoCompra implements java.io.Serializable {
    ...
    public NotaCreditoCompra(Long idNotaCreditoCompra, String numero, Integer timbrado, Date fechaVenciTimbrado,
